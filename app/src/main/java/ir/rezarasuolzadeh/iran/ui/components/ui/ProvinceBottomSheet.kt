 ...
 * county's name (or a placeholder if none is picked yet), with a button to confirm it.
 *
 * @param countyName the selected county's name, or `null` if nothing is selected.
